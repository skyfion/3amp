...
class CompressorFragment : AbstractThrFragment() {
    ...
    override fun initFragment() {
        ...
        initKnob(R.id.compressor_output_knob, R.id.c_output_text, Constants.COMPRESSOR_STOMP_OUTPUT)
        initKnob(R.id.compressor_sustain_knob, R.id.c_sustain_text, Constants.COMPRESSOR_STOMP_SUSTAIN)
...
//                blockActivator(R.id.compressor_empty_block, R.id.compressor_stomp, R.id.compressor_rack))
        // rack
        initKnob(R.id.c_threshold_knob, R.id.c_rack_threshold_text,
                Constants.COMPRESSOR_RACK_THRESHOLD, Pair(0, 600))
        initKnob(R.id.c_attack_knob, R.id.c_rack_attack_text,
                Constants.COMPRESSOR_RACK_ATTACK)
        initKnob(R.id.c_release_knob, R.id.c_release_text,
                Constants.COMPRESSOR_RACK_RELEASE)
        initKnob(R.id.c_rack_output_knob, R.id.c_rack_output_text, Constants.COMPRESSOR_RACK_OUTPUT, Pair(0, 600))
        initCarousel(R.id.compressor_knee_carousel, R.array.knee,
                Constants.COMPRESSOR_RACK_KNEE)
        initCarousel(R.id.compressor_ratio_carousel, R.array.ratio,
